...
<div class="wrap push">
  ...
  <?php 
  // PCT-ZOOM only - banner height reduce
    global $post;
    $post_slug = $post->post_name;
    
    if($post_slug === 'pct-zoom') : ?>
        <header class="short" style="background: url('<?php the_field('hero-image'); ?>'); max-height:300px; padding-bottom: 80px;">
    <?php else : ?>
        <header class="short" style="background: url('<?php the_field('hero-image'); ?>')">
    <?php endif; ?>
