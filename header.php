  ...
  <div class="container">
    <div class="banner-cont">
      ...
      <?php $front_id = get_the_ID(); ?>
        <?php $heroId = is_front_page() && (isset($_SESSION['user_country_code']) && $_SESSION['user_country_code'] == 'US') ? 'us-hero-slides' : 'hero-slides'; ?>
        ...
        <?php $i = 1; while( have_rows($heroId, $front_id) ): the_row(); ?>
          <div class="item">
            <header 
                ...
                <?php if(is_front_page() && $_SESSION['user_country_code'] != 'US') : ?>
                  style="background: url('<?php the_sub_field('hero-image'); ?>')"
                <?php endif ?>
              >
              <?php if(is_front_page() && (isset($_SESSION['user_country_code']) && $_SESSION['user_country_code'] == 'US')) : ?>
